...
public:
  OrbSLAMTest() {
    ...
    // const std::string voc_path = data_path + "/" + config.param<std::string>("orb_slam", "voc_path", "Vocabulary/ORBvoc.txt");
    ...
    system.reset(new ORB_SLAM3::System(voc_path, settings_path, ORB_SLAM3::System::MONOCULAR, false));
  }
...
int main(int argc, char** argv) {
  const std::string config_path = "/root/ros2_ws/src/glim_extension_test/config/glim_ext";  // ros::package::getPath("glim_ext") + "/config";
